                  ...
                  <Row>
                    ...
                    >
                      ...
                      >
                        <br></br>
                        <br></br>
                        After Registering , you will get free 1000 api hits and
                        be able to download the api collection
                      </Col>
                      ...
                      >
                        2 ) A zipped file will be downloaded which will consist
                        of the API collection in "json" format
                      </Col>
                      <Col span={24} style={{ padding: "2%" }}>
                        <Image
                          style={{
                      ...
                      >
                        ...
                        and click on "import" to import the downloaded
                        collection
                      </Col>
                      <Col
                        className="titles"
                      ...
                      <Col
                        ...
                        style={{ fontWeight: "bolder" }}
                      >
                        7) The imported collection is located in "Collections
                        tab"
                      </Col>
                      <Col
                        className="titles"
                    ...
                    >
                      <Row style={{ textAlign: "left" }}>
                        ...
                        >
                          ...
                          />
                          <br></br>
                          This API gives the information of all cities , based
                          on the state id
                        </Col>
                        ...
                        >
                          ...
                          />
                          <br></br>
                          This API gives the information of all banks in a
                          country
                        </Col>
